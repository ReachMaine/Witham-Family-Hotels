<?php /* 1july16 zig - copy single to modify 
*  - remove featured image stuff..
*  - remove the author block 
*  - dont show author or comments in meta 
*/?>
<?php get_header(); ?>
...
<div id="content" <?php Avada()->layout->add_style( 'content_style' ); ?> >
	...
	<?php while( have_posts() ) : the_post(); ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class( 'post' ); ?>>
			...
			<?php /* zig Xout 1jul16  if ( ! post_password_required( $post->ID ) ) : ?>
			...
			<?php if ( ! post_password_required( $post->ID ) ) : ?>
				<?php echo avada_render_post_metadata( 'single', array('post_meta_author' => '', 'post_meta_comments' => '') ); ?>
